...
from google.cloud.lineage_v1.services.lineage.transports.grpc_asyncio import LineageGrpcTransport
from google.cloud.lineage_v1.types.lineage import CreateLineageEventRequest, CreateProcessRequest, CreateRunRequest, LineageEvent, Run
...
class IngestLineage():
    ...
    def create_lineage_event(self, transport, run):
        ...
        lineageEvent = LineageEvent({
            "name": self.project_name + f"/lineageEvents/{lineage_event}",
            "sources": [],
            "targets": [],
